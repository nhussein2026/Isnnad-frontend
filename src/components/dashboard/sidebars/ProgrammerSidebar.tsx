// components/dashboard/sidebars/ProgrammerSibebar.jsx
import {
  Home,
  Users,
  Settings,
...
interface ProgrammerSidebarProps {
  toggleSidebar: () => void;
  toggleDarkMode: () => void;
  isCollapsed: boolean;
}

const ProgrammerSidebar = ({
  isCollapsed,
  toggleSidebar,
}: ProgrammerSidebarProps) => {
  const menuItems = [
...
export default ProgrammerSidebar;
